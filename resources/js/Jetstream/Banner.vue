<template>
    <div>
        <div :class="{ 'bg-green-600': style == 'success', 'bg-red-700': style == 'danger' }" v-if="show && message">
                ...
                <div class="flex items-center justify-between flex-wrap">
                    ...
                    <div class="flex-shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-green-600 focus:bg-green-500': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
